...
a) **Multa moratória** não compensatória de **{{operacao.taxa_multa_atraso}}% ({{operacao.taxa_multa_atraso_extenso}} por cento)** sobre o valor devido, nos termos do art. 52, §1º, do Código de Defesa do Consumidor, aplicável por analogia;
