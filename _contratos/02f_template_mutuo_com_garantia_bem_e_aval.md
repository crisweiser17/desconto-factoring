# Template: Contrato de Mútuo Feneratício COM ALIENAÇÃO FIDUCIÁRIA DE BEM MÓVEL E AVAL

**Arquivo:** `templates/mutuo_com_garantia_bem_e_aval.md`  
**Uso:** Empréstimos para MEI, ME ou EPP **com alienação fiduciária de bem móvel** (máquina, equipamento, mercadoria, etc — qualquer bem móvel que NÃO seja veículo automotor) **e com avalista**.  
**Fundamento legal:** Código Civil arts. 586-592, 818-839, 1.361 a 1.368-B; Lei Complementar 167/2019; CPC art. 784, III.

> **Variáveis exclusivas deste template:** `credor.*`, `devedor.*`, `avalista.*` (com bloco condicional para anuência conjugal), `operacao.*`, `bem.*`, `testemunhas.*`. Não usa `veiculo.*`.
