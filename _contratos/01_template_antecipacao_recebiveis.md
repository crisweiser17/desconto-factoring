...
**1.1.** Constitui objeto do presente Contrato a **cessão onerosa**, pelo CEDENTE à CESSIONÁRIA, de créditos representados por títulos de crédito e documentos representativos de crédito, de titularidade do CEDENTE, observada a disciplina dos artigos 286 a 298 do Código Civil e nos limites autorizados pela Lei Complementar nº 167/2019.
...
{{#avalista}}
**8.1.** Em garantia do fiel cumprimento das obrigações assumidas pelo CEDENTE neste Contrato e nos Borderôs firmados em sua execução, o AVALISTA, devidamente qualificado no preâmbulo, declara-se garantidor solidário e principal pagador, renunciando expressamente aos benefícios de ordem, divisão e excussão prévia (CC arts. 827, 828, 829 e 830).

**8.2.** A responsabilidade do AVALISTA persistirá até a efetiva e integral quitação de todas as obrigações do CEDENTE, não sendo afetada por moratórias, prorrogações ou repactuações concedidas pela CESSIONÁRIA, ainda que sem prévia consulta.

{{#avalista.casado}}
**8.3.** O(A) cônjuge do(a) AVALISTA, qualificado(a) no preâmbulo, comparece e manifesta sua expressa anuência, nos termos do art. 1.647, III, do Código Civil.
{{/avalista.casado}}
{{/avalista}}
...
b) A incluir o nome do CEDENTE e do AVALISTA (se houver) em cadastros restritivos de crédito;
...
**12.4.** O CEDENTE e o AVALISTA autorizam o tratamento de seus dados pessoais para fins das operações, nos termos da Lei Geral de Proteção de Dados (Lei 13.709/2018).
...
<p class="sig-role">CESSIONÁRIA:</p>
<div class="sig-space"></div>
<div class="sig-line"></div>
<p class="sig-name"><strong>ACM EMPRESA SIMPLES DE CRÉDITO LTDA</strong><br />
CNPJ: 63.530.897/0001-85<br />
p.p.: {{credor.representante.nome}}<br />
CPF: {{credor.representante.cpf}}</p>
</div>

<div class="signature-block">
<p class="sig-role">CEDENTE:</p>
<div class="sig-space"></div>
<div class="sig-line"></div>
<p class="sig-name">{{#cedente.pessoa_juridica}}<strong>{{cedente.razao_social}}</strong><br />
CNPJ: {{cedente.cnpj}}<br />
p.p.: {{cedente.representante.nome}}<br />
CPF: {{cedente.representante.cpf}}{{/cedente.pessoa_juridica}}{{^cedente.pessoa_juridica}}<strong>{{cedente.nome_completo}}</strong><br />
CPF: {{cedente.cpf}}{{/cedente.pessoa_juridica}}</p>
</div>
...
**4.1.** O CEDENTE declara, reitera e ratifica, neste ato e para esta operação, todas as declarações e garantias prestadas no Contrato-Mãe de Cessão Onerosa de Créditos (Cláusula 4ª), em especial quanto à existência, certeza, liquidez e exigibilidade dos créditos cedidos.

**4.2.** Aplicam-se a esta operação, integralmente, os termos e condições do Contrato-Mãe, que permanece em pleno vigor.
