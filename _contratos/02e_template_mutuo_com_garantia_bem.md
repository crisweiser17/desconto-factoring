# Template: Contrato de Mútuo Feneratício COM ALIENAÇÃO FIDUCIÁRIA DE BEM MÓVEL (sem avalista)

**Arquivo:** `templates/mutuo_com_garantia_bem.md`  
**Uso:** Empréstimos para MEI, ME ou EPP **com alienação fiduciária de bem móvel** (máquina, equipamento, mercadoria, ferramenta, mobiliário industrial, etc — qualquer bem móvel que NÃO seja veículo automotor), **sem avalista**.  
**Fundamento legal:** Código Civil arts. 586-592 e arts. 1.361 a 1.368-B; Lei Complementar 167/2019; CPC art. 784, III.

> **Variáveis exclusivas deste template:** `credor.*`, `devedor.*`, `operacao.*`, `bem.*`, `testemunhas.*`. Não usa `avalista.*` nem `veiculo.*`.

> **Diferença jurídica relevante:** Diferente do veículo (que tem Decreto-Lei 911/69 e gravame DETRAN), a alienação fiduciária de bem móvel comum se rege pelo Código Civil arts. 1.361 a 1.368-B e seu registro deve ser feito no **Cartório de Títulos e Documentos** do domicílio do devedor para ter eficácia perante terceiros.

---

# INSTRUMENTO PARTICULAR DE CONTRATO DE MÚTUO FENERATÍCIO COM ALIENAÇÃO FIDUCIÁRIA DE BEM MÓVEL EM GARANTIA

**Contrato nº {{operacao.id}}**

Pelo presente **INSTRUMENTO PARTICULAR DE CONTRATO DE MÚTUO FENERATÍCIO COM ALIENAÇÃO FIDUCIÁRIA DE BEM MÓVEL EM GARANTIA** (doravante denominado "CONTRATO"), firmado em {{operacao.local}}, {{operacao.data_extenso}}, as partes abaixo qualificadas:
...
**CONSIDERANDO** que o MUTUÁRIO solicitou à MUTUANTE a concessão de empréstimo em dinheiro, mediante a constituição de garantia real sobre bem móvel infungível;

**CONSIDERANDO** que a MUTUANTE aprovou a operação com base em análise de crédito própria e na qualidade do bem oferecido em garantia, e concorda em realizar o mútuo nas condições abaixo;
...
f) Falsidade, omissão ou inexatidão das declarações prestadas pelo MUTUÁRIO;
...
j) Dissolução, liquidação, cisão ou extinção do MUTUÁRIO.
...
c) **Cobrar do MUTUÁRIO o saldo devedor remanescente**, caso o produto da venda seja insuficiente para quitar integralmente a dívida e seus acessórios, com todos os encargos moratórios, podendo executar o presente Contrato como título executivo extrajudicial;
...
**7.1.** O MUTUÁRIO, por este instrumento, reconhece e confessa expressamente a dívida ora constituída como **líquida, certa e exigível**, nos exatos termos e valores pactuados, comprometendo-se pelo seu pagamento, na forma e prazos estabelecidos neste Contrato.
...
**11.5.** O MUTUÁRIO autoriza expressamente a MUTUANTE a tratar seus dados pessoais e empresariais para fins da operação, nos termos da Lei Geral de Proteção de Dados (Lei nº 13.709/2018), podendo compartilhá-los com bureaus de crédito, órgãos de proteção ao crédito, cartórios, advogados, assessorias de cobrança e autoridades legais, sempre que necessário para o cumprimento das obrigações contratuais ou legais.
